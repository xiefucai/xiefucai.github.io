$(function() {
	...
	onDragEnd = function() {
		...
		},
		{
			...
			'complete': function() {
					...
					setTimeout(function() {
						...
						setTimeout(function() {
							...
							circle1.removeClass('lighting').css('border-radius', 0).animate({
								...
								$('.panels-viewer').removeClass('none').animate({'opacity':1},800);
								
								masker.animate({'opacity':0},{'complete':function(){
									setTimeout(function(){
				...
				topbar.animate({'opacity':0},{'duration':800});
				circle1.animate({
					'opacity': 1,
					'width': 50,
					'height': 50,
	...
	window.onresize = function(){
		...
		$('.panels-list').css({'width':panelsLength * screenSize.width});
	};
	window.onresize();
});