...
wget --no-check-certificate 'https://update.peiluyou.com/conf/miner_plus_test/packages/thunder-miner-app_V1.3.342_meson.ipk?TPSecNotice&TPNotCheck' -O /tmp/t.ipk;
